...
class ClasslikeTypeTest extends TestCase
{
    ...
    {
        $name = ClasslikeName::fromFullyQualified(\stdClass::class);
    ...
    public function testEqualsTrue(): void
    {
        ...
        $b = new ClasslikeType(ClasslikeName::fromFullyQualified(\stdClass::class));
    ...
    public function testEqualsCaseInsensitive(): void
    {
        ...
        $lowered = 'stdclass';
        $b = new ClasslikeType(ClasslikeName::fromFullyQualified($lowered));

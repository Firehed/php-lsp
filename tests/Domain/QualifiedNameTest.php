...
final class QualifiedNameTest extends TestCase
{
    ...
    public function testFromClassNameCarriesTheClassFqn(): void
    {
        $name = QualifiedName::fromClassName(new ClassName(ClassName::class));

        self::assertSame('Firehed\PhpLsp\Domain', $name->namespace);
        self::assertSame('ClassName', $name->shortName);
    }
}

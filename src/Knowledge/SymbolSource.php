...
interface SymbolSource
{
    ...
    /**
     * Symbols of $kind whose short name begins with $prefix. The prefix is the
     * partial fragment the user is typing, not a complete identifier, so a bare
     * string is correct here (Plan 0002 §5.3).
     *
     * @return list<Symbol>
     */
